...
Iterable/AsyncIterable 内のいずれかの値が`f`の真偽テストに合格する場合、true を返します。
...
see [pipe](https://fxts.dev/ja/api/pipe)<!-- -->, [toAsync](https://fxts.dev/ja/api/toAsync)<!-- -->, [map](https://fxts.dev/ja/api/map)
