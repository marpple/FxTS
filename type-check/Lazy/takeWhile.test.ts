import { pipe, takeWhile, toAsync } from "../../src";
import * as Test from "../../src/types/Test";

const { checks, check } = Test;

const res1 = takeWhile((a) => a > 2, [1, 2, 3]);
const res2 = takeWhile(async (a) => a > 2, [1, 2, 3]);
const res3 = takeWhile((a) => a > 2, toAsync([1, 2, 3]));
const res4 = takeWhile(async (a) => a > 2, toAsync([1, 2, 3]));
