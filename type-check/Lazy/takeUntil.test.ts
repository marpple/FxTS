import { pipe, takeUntil, toAsync } from "../../src";
import * as Test from "../../src/types/Test";

const { checks, check } = Test;

const res1 = takeUntil((a) => a > 2, [1, 2, 3]);
const res2 = takeUntil(async (a) => a > 2, [1, 2, 3]);
const res3 = takeUntil((a) => a > 2, toAsync([1, 2, 3]));
const res4 = takeUntil(async (a) => a > 2, toAsync([1, 2, 3]));
