import { intersectionBy, toAsync } from "../../src";
import * as Test from "../../src/types/Test";

const { checks, check } = Test;

const res1 = intersectionBy((a) => a, [1, 2, 3, 4], [5, 6, 3, 4]);
const res2 = intersectionBy((a) => String(a), [1, 2, 3, 4], [5, 6, 3, 4]);
const res3 = intersectionBy((a) => a, toAsync([1, 2, 3, 4]), [5, 6, 3, 4]);
const res4 = intersectionBy((a) => a, [1, 2, 3, 4], toAsync([5, 6, 3, 4]));
const res5 = intersectionBy(
  (a) => a,
  toAsync([1, 2, 3, 4]),
  toAsync([5, 6, 3, 4]),
);
